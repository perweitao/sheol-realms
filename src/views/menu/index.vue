<template>
  <div class="app-container">
    ...
    <menu-tree-table
      ...
      @deleteOperateEvent="deleteOperateEvent"
    ></menu-tree-table>
...
import {
  ...
  addMenu,
  updateMenu
} from "@/api/menuControl";
import { handleTree, selectDictLabel } from "@/utils/index";
import Treeselect from "@riophae/vue-treeselect";
import "@riophae/vue-treeselect/dist/vue-treeselect.css";
import IconSelect from "@/components/IconSelect";
import MenuTreeTable from "./menuTree/MenuTreeTable";

export default {
  name: "Menu",
  components: { Treeselect, IconSelect, MenuTreeTable },
  data() {
    return {
      // 遮罩层
      loading: true,
